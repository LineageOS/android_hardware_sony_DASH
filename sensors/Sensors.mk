...
$(SOMC_CFG_SENSORS_LIGHT_AS3677)-files += as3677_als.c
$(SOMC_CFG_SENSORS_LIGHT_AS3677)-cflags += \
    -DLIGHT_RANGE=$(if $(SOMC_CFG_SENSORS_LIGHT_AS3677_MAXRANGE),$(SOMC_CFG_SENSORS_LIGHT_AS3677_MAXRANGE),12276)

ifneq ($(SOMC_CFG_SENSORS_LIGHT_AS3677_PATH),)
$(SOMC_CFG_SENSORS_LIGHT_AS3677)-cflags += -DALS_PATH=\"$(SOMC_CFG_SENSORS_LIGHT_AS3677_PATH)\"
endif
